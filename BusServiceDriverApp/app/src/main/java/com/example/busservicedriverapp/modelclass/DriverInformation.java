...
public class DriverInformation implements Parcelable {
    ...
    private  String uid,driverName,driverEmail,driverPhoneNumber,driverNID,
        ...
        vehicleLicenseNumber,vehicleLicenseExpiryDate,busCatagory,busroute;

    public DriverInformation() {
    }

    public DriverInformation(String uid, String driverName, String driverEmail, String driverPhoneNumber, String driverNID, String driverPictureUri, String driverLicenseNumber, String driverLicenseExpireDate, String vehicleLicenseNumber, String vehicleLicenseExpiryDate, String busCatagory, String busroute) {
        this.uid = uid;
