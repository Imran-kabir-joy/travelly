...
import com.example.busservicedriverapp.modelclass.Report;
...
public class DriverHomeActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    DatabaseReference reference,rating_ref;
    ValueEventListener lisener_reference,lisener_rating_ref;
    RatingBar ratingbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference=FirebaseDatabase.getInstance().getReference().child("reportlist").child(FirebaseAuth.getInstance().getCurrentUser().getUid());
        lisener_reference=reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                list.clear();
                for(DataSnapshot ds:dataSnapshot.getChildren()){
                    Report report=ds.getValue(Report.class);
                    list.add(new ReportModel(report.getReport_date(),report.getReport_body(),report.getRepoter_name()));
                }
        ...
        rating_ref=FirebaseDatabase.getInstance().getReference().child("driverrating").child(FirebaseAuth.getInstance().getCurrentUser().getUid());
        lisener_rating_ref=rating_ref.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ratingbar.setRating((float) (ratingSum/totalRating));
                Log.d(TAG, "rating:"+(float) (ratingSum/totalRating));
            }
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                reference.removeEventListener(lisener_reference);
                rating_ref.removeEventListener(lisener_rating_ref);
    ...
    protected void onStart() {
        ...
        /*FirebaseUser user=new FirebaseUser() {
            ...
            public String getUid() {
                return "XymEt5islpXq0nPXRYPQ1mDIoyS2";
            }
